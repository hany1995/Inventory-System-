...
public class AppendWorker extends Parent implements ActionListener{
    public AppendWorker(){
            setLocation(100, 200);
         setSize(400, 300);
         ...
         this.getContentPane().setLayout(null);
          ...
          Label1 = new JLabel("Append on  Worker");
        ...
        add(Label1);add(Label2); add(Label3);add(Text1);add(Text2);add(Label4);add(Text3);
        ...
        Back.addActionListener(this);
           ...
           public static void main (String[] args) {
            AppendWorker main = new AppendWorker();
        ...
        if(e.getSource()==Next){
           ...
           HR h = new HR();
               ...
               if (fr.ID.contains("-") ){
                   ...
                   JOptionPane.showMessageDialog(null, "You Append On Worker Get Back to main");
